...
public class gestionDocente extends JPanel implements ActionListener {
    ...
    public void Titulo(){
        ...
        label_GE = new JLabel("Gestión de Docentes");
        label_GE.setFont(GE);
        label_GE.setBounds(270, 50, 520, 50);
        add(label_GE);
    ...
    public void Mostrar(String Nombre){
        ...
        if (Nombre.equals("")) {
            ...
            sql = "Select * from docente where nombre like '%"+Nombre+"%'";
        }
...
//            txt_Date.setDate(table.getValueAt(fila, 5));
    ...
    public void Update(){
        ...
        try {
            ...
            "Update docente set id_docente=?, nombre=?, apellido=?, correo=?, telefono=?, fecha_nacimiento=?, horario=?, cargo=?"
            + "where id_docente = '" + nIdentificacion + "'");
        ...
        if (n == JOptionPane.YES_NO_OPTION) {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "Delete from docente where id_docente = '" + nIdentificacion + "'");
