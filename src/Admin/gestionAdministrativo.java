...
public class gestionAdministrativo extends JPanel implements ActionListener {
    ...
    private JTextField txt_Nombre, txt_Apellido, txt_Email, txt_Telefono, txt_Horario, txt_Cargo, txt_Buscar;
    ...
    public void Titulo(){
        ...
        label_GE = new JLabel("Gestión de Administrativos");
        label_GE.setFont(GE);
        label_GE.setBounds(200, 50, 700, 50);
        add(label_GE);
        
    }
    public void ID(){
        
        lb_id = new JLabel("Número de Identificación");
    ...
    public void Programa(){
        ...
        txt_Horario = new JTextField();
        txt_Horario.setFont(fuente1);
        txt_Horario.setBounds(70, 230, 300, 20);
        txt_Horario.setHorizontalAlignment(JTextField.CENTER);
    ...
    public void Jornada(){
        ...
        txt_Cargo.setFont(fuente1);
        txt_Cargo.setBounds(382, 230, 300, 20);
        txt_Cargo.setHorizontalAlignment(JTextField.CENTER);
    }
    ...
    public void Mostrar(String Nombre){
        ...
        if (Nombre.equals("")) {
            ...
            sql = "Select * from administrativo where nombre like '%"+Nombre+"%'";
        }
...
//            txt_Date.setDate(table.getValueAt(fila, 5));
            txt_Horario.setText(table.getValueAt(fila, 6).toString());
            txt_Cargo.setText(table.getValueAt(fila, 7).toString());
        }else {
    ...
    public void verde(){
        ...
        txt_Cargo.setBackground(Color.green);
    }
    public void blanco(){
        ...
        txt_Horario.setBackground(Color.WHITE);
    ...
    public void Update(){
        ...
        horario = txt_Horario.getText().trim();
        cargo = txt_Cargo.getText().trim();
        try {
            Connection cn2 = Conexion.conectar();
            PreparedStatement pst2 = cn2.prepareStatement(
            "Update administrativo set id_administrativo=?, nombre=?, apellido=?, correo=?, telefono=?, fecha_nacimiento=?, horario=?, cargo=?"
            + "where id_administrativo = '" + nIdentificacion + "'");
        ...
        if (n == JOptionPane.YES_NO_OPTION) {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "Delete from administrativo where id_administrativo = '" + nIdentificacion + "'");
