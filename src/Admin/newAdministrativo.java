...
public class newAdministrativo extends JPanel implements ActionListener {
    
    private JDateChooser txt_Date;
    private JButton btnGuardar, btnTomarFoto;
    private JLabel j10, j11, j12, j13, j14, j15, j16, j17, j18,j19, re;
    private JTextField txt_id, txt_Nombre, txt_Apellido, txt_Email, txt_Telefono, txt_Horario, txt_Cargo;
    ...
    public void Titulo(){
        ...
        j10 = new JLabel("Administrativo Nuevo");
        j10.setFont(adm);
        j10.setBounds(220, 50, 600, 40);
        add(j10);
    ...
    public void Horario(){
        ...
        txt_Horario.setBounds(70, 460, 300, 20);
    ...
    public void Cargo(){
        ...
        txt_Cargo.setBounds(382, 460, 300, 20);
    ...
    public void Guardar(){
        ...
        fNacimiento = txt_Date.getDateFormatString().trim();
            ...
            if (rs.next()) {
                ...
                cn.close();
                   try {
                    ...
                    pst2.setString(7, cargo);
                    pst2.setString(8, horario);
                    pst2.executeUpdate();
                    cn2.close();
